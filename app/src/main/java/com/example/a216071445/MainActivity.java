...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NeedNewAccount = (TextView) findViewById(R.id.register);
        ...
        NeedNewAccount.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent = new Intent(MainActivity.this,Tuyisenge.class);
    ...
    public void submit(){
        ...
        if (c != null){
            if (c.getCount() > 0){
                ...
                Intent intent = new Intent(MainActivity.this,Etienne.class);
                startActivity(intent);
            }
